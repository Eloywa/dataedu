...
KEYWORDS = {
    "Нормализация": [
        "нормализ", "нормальн", "избыточност", "аномали", "1нф", "2нф", "3нф",
        "декомпозиц", "дублирован",
    ],
    "ER-моделирование": [
        "er-", "er ", "сущность", "сущност", "кардинальн", "диаграмм", "связь между",
    ],
    "Транзакции": [
        "транзакц", "commit", "rollback", "блокировк", "изоляц", "acid", "deadlock",
    ],
    "Индексы": ["индекс", "b-tree", "btree", "seq scan", "index scan"],
    "Производительность": [
        "производительн", "explain", "план запроса", "оптимизац", "медленн",
    ],
    "Проектирование БД": [
        "первичный ключ", "внешний ключ", "primary key", "foreign key", "схем",
        "проектирован", "атрибут", "тип данных", "constraint", "целостност",
    ],
    "PostgreSQL": [
        "psql", "postgres", "coalesce", "serial", "sequence", "расширени",
    ],
    "SQL": [
        "select", "where", "join", "group by", "order by", "count", "avg(", "sum(",
        "distinct", "having", "limit", "запрос", "выборк", "оконн", "over(",
